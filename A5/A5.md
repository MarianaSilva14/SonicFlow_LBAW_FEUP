...
| R06                | Commentary(<u>id</u>, username → Customer, date, text NN, flagsNo NN) |
| R07                | Answer(idParent → Commentary, idChild → Commentary) |
| R08                | Flagged(idComment → Commentary, hidden NN) |
| R09                | Product(<u>sku</u> , title NN, cat → Category NN, price NN CK price > 0, discountPrice, rating NN, stock NN) |
| R10                | Attribute(<u>id</u>, name NN) |
| R11                | AttributeProduct(<u>idAttribute</u> → Attribute, <u>refProduct</u> → Product, value) |
| R12                | CatAtt(<u>att</u> → Attribute, <u>cat</u> → Category) |
| R13                | Category(<u>name</u>) |
...
| R17                | Rating(<u>username</u> → Customer, <u>refProduct</u> → Product, value NN CK > 0 AND CK <= 5) |
