...
SELECT *
FROM product, category_attribute, attribute_product, attribute
WHERE 	product.sku = attribute_product.product_idproduct
	AND	attribute_product.attribute_idattribute = attribute.id
	AND category_attribute.attribute_idattribute = attribute.id
	AND category_attribute.category_idcategory = product.category_idcat
	AND product.sku = $sku;
