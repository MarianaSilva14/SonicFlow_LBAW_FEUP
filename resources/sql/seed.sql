DROP IF EXISTS "user" CASCADE;
DROP IF EXISTS customer CASCADE;
DROP IF EXISTS moderator CASCADE;
DROP IF EXISTS administrator CASCADE;
DROP IF EXISTS banned CASCADE;
DROP IF EXISTS category CASCADE;
DROP IF EXISTS product CASCADE;
DROP IF EXISTS comment CASCADE;
DROP IF EXISTS answer CASCADE;
DROP IF EXISTS flagged CASCADE;
DROP IF EXISTS attribute CASCADE;
DROP IF EXISTS attribute_product CASCADE;
DROP IF EXISTS category_attribute CASCADE;
DROP IF EXISTS favorite CASCADE;
DROP IF EXISTS purchase CASCADE;
DROP IF EXISTS purchase_product CASCADE;
DROP IF EXISTS rating CASCADE;
...
CREATE  OR REPLACE TRIGGER check_banned_date BEFORE INSERT OR UPDATE ON banned
...
CREATE OR REPLACE TRIGGER check_answer_date BEFORE INSERT OR UPDATE ON answer
...
CREATE OR REPLACE TRIGGER update_product_rating AFTER INSERT OR UPDATE ON rating
...
CREATE OR REPLACE TRIGGER constraint_product_discount BEFORE INSERT OR UPDATE ON product
...
CREATE OR REPLACE TRIGGER insert_update_product BEFORE INSERT OR UPDATE ON product
...
CREATE OR REPLACE TRIGGER insert_update_comment BEFORE INSERT OR UPDATE ON comment
