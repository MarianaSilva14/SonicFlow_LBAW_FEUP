...
<table>
  ...
  <tr>
    <td colspan="2">
      <samp>
        SELECT Product.sku, Product.title, Product.idCat, Product.category, Product.price, Product.discountPrice, Product.rating
...
<table>
  ...
  <tr>
    <td colspan="2">
      <samp>
        SELECT Product.sku, Product.title, Product.idCat, Product.category, Product.price, Product.discountPrice, Product.rating, attribute."name", attribute_product."value",
        category."name"
