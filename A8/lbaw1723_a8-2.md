...
* Changed routes to accomodate to use middleware api
* Put all accesses to the database on the models
* Added error notices with more visibility
* Added catch of more exceptions
