...
|:---------:|-----|:-------:|-----------|
|US01|Search|high|As an User, I want to consult all the public information, so that I can see what information the system provides.|
...
|US05|Shopping cart|high|	As an User, I want to add items to a shopping cart, so that I can track everything I intend to buy.|
|US06|Comparison|	medium	|As an User, I want to compare similar products, so that I can check similarities and differences between two products.|
|US07|FAQ page|medium|	As an User, I want to access FAQ page, so that I can see FAQ's.|
|US08|Configurator|medium|	As an User, I want to access the system configurator, so that I can configure a custom computer build.|
...
|US55|Account Delete|high|	As an Owner, I want to be able to delete my account.|
|US56|Log out	|high|	As a Owner, I want to logout from my account.|
