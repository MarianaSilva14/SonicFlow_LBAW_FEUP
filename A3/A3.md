...
* Added Moderation Management in Sitemap.
* Changed price display consistency in Homepage, this change can be viewed in [here](https://xfontes42.github.io/lbaw1723/delivery/homepage.html).
* Added more weight to the top right information in Homepage, this change can be viewed in [here](https://xfontes42.github.io/lbaw1723/delivery/homepage.html).
* ! Changed display of currently selected category, this change can be viewed in [here](https://xfontes42.github.io/lbaw1723/delivery/product.html).
* ! Changed footer to incorporate an ending to the main page, this change can be viewed in [here](https://xfontes42.github.io/lbaw1723/delivery/homepage.html).
* ! Added an introduction in the Configurator page and the price is always visible, this change can be viewed in [here](https://xfontes42.github.io/lbaw1723/delivery/configurator.html).
