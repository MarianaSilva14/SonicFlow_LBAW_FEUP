...
+ R211: Administration product view /admin/products
...
+ R301: Add and answer a comment /product/{id}/comment
+ R302: Flag comment /comment/{id}/flag
+ R303: List comments /product/{id}/comment
+ R304: Delete comments /users/{id}/shoppingCart
+ R305: Add and remove items from the wish list /users/{id}/loyaltypoints
+ R306: List a customer's wish list

##### R301: Add and answer a comment
