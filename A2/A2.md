...
|US23|Comment|high|	As a Customer, I want to register a comment, so that I can manifest my opinion about a product.|
|US24|Rate|high|	As a Customer, I want to rate a product so that I can classify it.|
|US25|Purchase History|medium|	As a Customer, I want to access my purchase history.|
|US26|Newsletter|medium|	As a Customer, I want to enable or disable newsletter.|
|US27|Availability|low| As a Custumer, I want to be able to be notified when a product is available.|
