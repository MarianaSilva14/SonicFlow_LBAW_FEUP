...
|:---------:|-----|-----------|
|BR01|Authentication|Only an user authenticated as a customer can buy products.|
...
|Identifier	|Name	|Description|
|:---------:|-----|-----------|
|C01|Consistency|A customer can only comment on a product he has previously bought.|
|C02|Stock Management|A product can only be bought if it is available.|
